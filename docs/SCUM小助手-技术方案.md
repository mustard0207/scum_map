...
> 版本：v7.8 (POI分类筛选+emoji标记) | 更新日期：2026-06-26
...
- **当前使用**：Z2+Z4 分层加载
  - Z2 概览图（1280x1280，455KB JPG Q=80）— 主包本地内置，scale < 1.5 时使用
  - Z4 中景图（4×4 网格，每块 640x640 webp）— jsDelivr 网络加载 + 本地缓存，scale ≥ 1.5 时使用
